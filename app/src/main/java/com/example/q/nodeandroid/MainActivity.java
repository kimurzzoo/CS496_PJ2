package com.example.q.nodeandroid;
...
class Progressi extends AsyncTask<Stringman,String,String>{
    ...
    protected String doInBackground(Stringman... text1) {
        HttpUrl httpUrl = new HttpUrl.Builder().scheme("http").host("13.124.144.112").port(8080).encodedPath("/api/phones").build();
        ...
        jsonStr = "{" + "\"name\"" + " : " +  "\"" +text1[0].text1  + "\""+ ","
                    + "\"phone_number\"" + " : " + "\"" + text1[0].text2 + "\"" +"}";
